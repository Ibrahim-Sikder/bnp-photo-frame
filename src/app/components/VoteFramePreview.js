...
export default function VoteFramePreview({ uploadedImage, selectedFrame, zoom, offsetX, offsetY, canvasRef, }) {
    ...
    return (_jsxs("div", { ref: containerRef, className: "flex flex-col items-center justify-center w-full", children: [_jsx("style", { dangerouslySetInnerHTML: {
      ...
      `
                } }), _jsxs("div", { className: "relative w-full", children: [_jsx("canvas", { ref: canvasRef, className: "preview-canvas w-full rounded-lg md:rounded-xl shadow-2xl border-2 md:border-4 border-white ring-1 md:ring-2 ring-gray-200 bg-white", style: {
                            aspectRatio: "1 / 1",
                            objectFit: "contain"
